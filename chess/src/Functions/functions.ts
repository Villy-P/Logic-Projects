class Functions {
    ...
    public static drawRect(color: string, x: number, y: number, width: number, height: number) {
        World.context.fillStyle = color;
        World.context.fillRect(x, y, width, height)
    }

    public static drawStrokeRect(color: string, x: number, y: number, width: number, height: number) {
    ...
    public static extractKeyValue(obj: Map<string, number>, value: number): string {
